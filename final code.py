...
st.set_page_config(
    page_title="الحاسبة المالية المتقدمة | فوائد وقروض", # <-- عنوان محسن
    page_icon="llogo.png",
    layout="centered",
...
st.title("الحاسبة المالية المتقدمة")

# وصف موجز وغني بالكلمات المفتاحية
st.markdown("""
أداة مالية شاملة لحساب **الفائدة البسيطة**، **الفائدة المركبة**، و**القسط الشهري للقروض**. 
